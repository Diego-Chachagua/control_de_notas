...
$query = "SELECT tbl_estudiantes.dui, tbl_estudiantes.nie, tbl_estudiantes.nombre_estudiante, tbl_estudiantes.apellido_estudiante, tbl_estudiantes.cod_grado, tbl_secciones.seccion, tbl_materias.cod_materia, tbl_promedio.promedio_p1, tbl_promedio.promedio_p2, tbl_promedio.promedio_p3, tbl_promedio.promedio_p4, tbl_promedio.promedio_f, tbl_promedio.promedio_r, tbl_promedio.promedio_t FROM tbl_estudiantes INNER JOIN tbl_secciones ON tbl_secciones.cod_seccion=tbl_estudiantes.cod_seccion INNER JOIN tbl_promedio ON tbl_estudiantes.nie=tbl_promedio.nie INNER JOIN tbl_materias ON tbl_promedio.cod_materia=tbl_materias.cod_materia where tbl_estudiantes.nie='$nie'";
